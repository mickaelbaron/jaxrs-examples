 ...
 */
public class LibraryRestWebServiceLauncher {
	...
	public static void main(String[] args) throws IOException {
		...
		resourceConfig.registerClasses(BookContentResource.class, BookResource.class, BookResponseResource.class, SpecificBookResource.class);
